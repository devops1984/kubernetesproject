	...
	stages {
		...
		stage('Docker Build and Deploy') {
			...
			//execCommand: 'sh sudo docker login ; sh */deploy.sh', 
	              execCommand: 'sudo docker login; sudo docker build -t k2r2t2/demoapp Dockerfile .; docker tag demoapp k2r2t2/demoapp:latest; docker run -d -p 8003:8080 k2r2t2/demoapp',
		      execTimeout: 120000, 
